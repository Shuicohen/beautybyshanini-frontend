  ...
  return (
    <>
      ...
      <nav
        ...
        `}
      >
        <h2 className="text-base sm:text-lg md:text-2xl font-bold text-pink-accent mb-4 sm:mb-6 md:mb-8 pt-16 md:pt-2">Admin Dashboard</h2>
          ...
          {tabs.map((tab) => (
            <li key={tab.name}>
              <button
                ...
                className={`w-full flex items-center py-2 sm:py-2.5 md:py-3 px-2 sm:px-3 md:px-4 rounded-lg transition ${activeTab === tab.name ? 'bg-pink-accent text-white' : 'hover:bg-pink-accent/10'
                  }`}
              >
